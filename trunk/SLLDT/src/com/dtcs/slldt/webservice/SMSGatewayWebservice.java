...
public class SMSGatewayWebservice {
	...
	public static void getListSmsChat(final WebserviceTaskListener<ArrayList<SMSModel>> webserviceTaskListener){		
		new AsyncTask<Void, Void, ArrayList<SMSModel>>() {
			ResultModel refResult = new ResultModel(); 
			@Override
			protected ArrayList<SMSModel> doInBackground(Void... params) {
				ArrayList<SMSModel> ret = new WSGetSMS().getListSmsChat(refResult);
				return ret;
			}
